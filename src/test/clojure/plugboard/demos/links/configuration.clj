...
;; TODO: Create a default plugboard which combines a useful selection of
;; plugboards instead of building each plugboard from scratch for each demo.
...
(defn create-plugboard []
  (plugboard.core.plugboard/merge-plugboards
   ...
   (plugboard.webfunction.plugboards/web-function-resources
    (map find-ns ['plugboard.demos.links.webfunctions]))
